...
export const CartContextProvider = ({children}) => {
    ...
    function carritoPopUp() {
        ...
        const totalItemsCarrito = cartList.map(prod => prod.cantidad).reduce((cantPrevia, cantActual) => cantPrevia + cantActual, 0)
    ...
    function precioTotalCarrito() {
        ...
        const sumaTotal = cartList.map(total => total.cantidad * total.precio).reduce((costoPrevio, costoActual)=> costoPrevio + costoActual, 0)
        return sumaTotal
