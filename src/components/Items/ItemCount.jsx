    ...
    <div>
      {inputType === 'button' ? (
        <div>
          <div className='contador-container'>
            <button
              ...
              onClick={restaContador}
            >
              <BsCaretDownFill />
            </button>
            <button type='button' className='btn btn-light contador'>
              {contador}
            </button>
            <button
              type='button'
          ...
          <button
            ...
            className='btn btn-outline-primary btn-agregar'
          >
        ...
        <div className='detail-btn-checkout'>
          <Link to='/cart'>
            <button className='btn btn-outline-success btn-agregar'>
              <BsCheckCircle className='me-2 mb-1' /> Finalizar compra
            </button>
          </Link>
          <Link to='/productos'>
            <button className='btn btn-outline-primary'>
              <BsCart4 className='me-2 mb-1' />
              Seguir comprando
            </button>
          </Link>
        </div>
